...
describe('/api/genres',()=>{
    ...
    describe('POST/',()=>{
        ...
        //Mosh's refactoring technique for clean and efficient tests
        // Define the happy path, and then in each test, we change 
        // one parameter that clearly alingns with the name of the 
        // test.
        let token;
        let name;
    ...
    describe('DELETE/',()=>{
        ...
        it('should return the deleted object if valid id passed', async ()=>{
            const res = await exec();
            expect(res.status).toBe(200);
